...
// https://github.com/brakmic/Angular-VR-Starter/blob/master/src/platform/polyfills/request-frame-alt.js
...
function requestFrame(type) {
  ...
  function hasIOS6RequestAnimationFrameBug() {
    ...
    var iOS6Notice =
      'setTimeout is being used as a substitiue for \n            requestAnimationFrame due to a bug within iOS 6 builds';
  ...
  function queryCancelAnimationFrame() {
    ...
    assignedCancelAnimationFrame =
      window['cancel' + aF] || prefixedCancelAnimationFrame(cancellationNames, 0) || clearTimeoutWithId;
